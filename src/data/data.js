...
import biswa from "../assets/team/biswarghya.jpg"
...
import sayak from "../assets/team/sayak.webp"
import aditya from "../assets/team/aditya.webp"
import somnath from "../assets/team/somnath.webp"
...
export const data = [
    ...
    {name: "Sayak Bhattacharjee", desg: "Web Team", img: sayak, socialL: [{ isPres: "GIT", Slink: "https://github.com/Sayak18"}, {isPres: "LINKEDIN", Slink: "https://www.linkedin.com/in/sayak-bhattacharjee-0999341b4/"}, {isPres: "TWIT", Slink: "https://twitter.com/Sayak_187"}]},
    {name: "Aditya Giri", desg: "Web Team", img: aditya, socialL: [{ isPres: "GIT", Slink: "https://github.com/aditya-464"}, {isPres: "LINKEDIN", Slink: "www.linkedin.com/in/aditya-giri-948420226"}]},
    {name: "Somnath paul", desg: "App Team Co-Lead", img: somnath, socialL: [{ isPres: "GIT", Slink: "https://github.com/sp-xd"}, {isPres: "LINKEDIN", Slink: "https://linkedin.com/in/spxd/"}]},
    {name: "Sayan Ghosh", desg: "CP Team Lead", img: sayanG, socialL: [{ isPres: "GIT", Slink: "https://www.github.com/neme-sis"}, {isPres: "LINKEDIN", Slink: "https://www.linkedin.com/in/sayan-ghosh-00b7b2220"}]},
    {name: "Debanita Roy Bhowmick", desg: "Cloud Team Lead", img: debanita, socialL: [{isPres: "LINKEDIN", Slink: "www.linkedin.com/in/debanita-roy-bhowmick"}, {isPres: "TWIT", Slink: "https://twitter.com/DebanitaRB"}]},
    {name: "Pubali Basak", desg: "ML Team Lead", img: pubali, socialL: [{ isPres: "GIT", Slink: "https://github.com/int-code"}, {isPres: "LINKEDIN", Slink: "https://www.linkedin.com/in/pubali-basak"}]},
]

/* [{name: "<NAME_OF_USER>", desg: "<DESIGNATION>", img: "<IMAGE_DP_URL>", socialL: [{ isPres: "GIT", Slink: "<GITHUB_LINK>"}, {isPres: "LINKEDIN", Slink: "<LINKEDIN_LINK>"}, {isPres: "TWIT", Slink: "<TWITTER_LINK>"}]}] */
